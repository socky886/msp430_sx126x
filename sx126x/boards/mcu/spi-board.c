...
void SpiInit( Spi_t *obj, SpiId_t spiId, PinNames mosi, PinNames miso, PinNames sclk, PinNames nss )
{
    ...
    GpioInit(&obj->Miso, miso, PIN_OUTPUT, PIN_PUSH_PULL, PIN_PULL_DOWN, 0);
...
// uint16_t SpiInOut2( Spi_t *obj, uint16_t outData )
// {
//     uint8_t rxData = 0;
...
// {
//         int i;
//         uint16_t inData = 0x00;

//         GpioWrite( & obj->Sclk, 0 );
...
//                  //set the data
//         if (outData & 0x80)
//             GpioWrite(&obj->Mosi, 1);
//                 else             GpioWrite(&obj->Mosi, 0);

//                  //start the clock
//         GpioWrite(&obj->Sclk, 1);

//                 if (GpioRead(&obj->Miso))
//             inData |= 0x01;
...
//             
//     }
//         GpioWrite(&obj->Mosi, 0);

//         return inData;
// }

// int SpiInOut(Spi_t *obj, uint16_t outData)
// {
//     return 0x00;
// }
